// The People & Locations tab: the two sub-panels, the tab switch between
// them, and the per-person evidence count that links back to the
// Evidence tab filtered to that person.
...
// Only switchPeopleTab writes this and nothing reads it, so it stays here.
